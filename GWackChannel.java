...
public class GWackChannel extends Thread implements KeyListener{
    ...
    private GWackChannel gui;
    private PrintWriter out;
    private BufferedReader in;
    GWackChannel(String ip, int port, String name, JTextArea messagestxt, JTextArea composetxt, JTextArea memberstxt,GWackClientGUI gui){
        sock=null;       
        this.ip=ip;
        this.name=name;
        this.port=port; 
